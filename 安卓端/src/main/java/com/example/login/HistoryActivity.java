...
public class HistoryActivity extends AppCompatActivity {
    ...
    /* 获取指定年份月份收支情况的列表*/
    private void loadData(int year,int month,String logname) {
        List<AccountBean> list = DBManager.getAccountListOneMonthFromAccounttb(year, month,logname);
        mDatas.clear();
        mDatas.addAll(list);
        adapter.notifyDataSetChanged();
    }
